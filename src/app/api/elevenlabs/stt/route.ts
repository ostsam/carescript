 ...
 *   - audio:       Audio file (mp3, wav, m4a, ogg, flac) — required
 *   - language:    ISO 639-1 code (e.g. "en") — optional, defaults to auto-detect
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error("[STT] ElevenLabs transcription error:", err);
    return NextResponse.json(
